...
public class Lcspusrs implements java.io.Serializable {
	...
	* 
	*/
	private static final long serialVersionUID = -2384774892714468320L;
	...
	public Lcspusrs(String pkid, String member, String usrprf, String notify, String text, Integer forgot,
			Integer bnknbr, Integer branch, Integer dptnbr, Integer teller, Integer dtaent, Integer bchnbr,
			String acntnb, String cbsaut, Integer dtalib, String rotpsw, String clsusr, String nroleg, Date usdtad,
			String usraut, String uslcl, String xpau, Long grbnbr, String ususac, Date usdtac, Date ustmac) {
		this.pkid = pkid;
		this.member = member;
		this.usrprf = usrprf;
		this.notify = notify;

...
public class Tablam implements java.io.Serializable {
	...
	* 
	*/
	private static final long serialVersionUID = -1622686600263818491L;
	...
	public Tablam(String pkid, String member, String ctabla, String cvalor, String cautor, String tdescr,
			String cbaja) {
		this.pkid = pkid;
		this.member = member;
		this.ctabla = ctabla;

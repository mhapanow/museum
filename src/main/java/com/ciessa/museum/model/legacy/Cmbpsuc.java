...
public class Cmbpsuc implements java.io.Serializable {
	...
	* 
	*/
	private static final long serialVersionUID = -6994369703785319486L;
	...
	public Cmbpsuc(String pkid, String member, Integer sumclc, String sumchn, Integer subrch, String suolfg,
			String suctfg, String sucmnd) {
		this.pkid = pkid;
		this.member = member;
		this.sumclc = sumclc;
		this.sumchn = sumchn;

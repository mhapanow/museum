...
import com.ciessa.museum.dao.legacy.Cfp00102DAO;
...
public class TAR0030View01BzService extends RestBaseServerResource{
    ...
    Cfp00102 objCfp00102 = new Cfp00102();
	...
	public String view() {
		...
		try {
			...
			objCfp00102 = myDaoCfp00102.getUsingKey(ds, tipo, dmtype);
			typdes = objCfp00102.getCftnme();
